...
extern void F1049_9100(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1049_9100 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1048, Current, 0, 1, 15393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 15393);
...
body:;
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6866, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1049_9106 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 15394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 15394);
	RTIV(Current, RTAL);
	RTHOOK(1);
