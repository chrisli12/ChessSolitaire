...
extern EIF_TYPED_VALUE F1052_9118(EIF_REFERENCE);
...
RTOID (F1052_9118)
EIF_TYPED_VALUE F1052_9118 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1051, Current, 0, 0, 15396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
