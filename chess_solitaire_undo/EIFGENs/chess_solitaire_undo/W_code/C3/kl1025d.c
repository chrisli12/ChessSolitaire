...
static const EIF_TYPE_INDEX egt_13_1025 [] = {0xFF01,1137,0xFFFF};
...
static const struct desc_info desc_1025[] = {
	...
	{EIF_GENERIC(egt_13_1025), 15095, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0191 /*200*/), 15096, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0191 /*200*/), 15097, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0185 /*194*/), 15098, 0xFFFFFFFF},
...
void Init1025(void)
{
	...
	IDSC(desc_1025 + 32, 575, 1024);
	IDSC(desc_1025 + 33, 873, 1024);
}
