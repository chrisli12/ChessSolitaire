...
extern void F982_16453(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14859);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14859);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F982_16453 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 981, Current, 0, 16452);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
