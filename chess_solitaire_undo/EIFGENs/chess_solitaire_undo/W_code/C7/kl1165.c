...
extern EIF_TYPED_VALUE F1165_10234(EIF_REFERENCE);
...
RTOID (F1165_10234)
EIF_TYPED_VALUE F1165_10234 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1164, Current, 0, 0, 16815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1164, Current, 16815);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
