...
extern EIF_TYPED_VALUE F1161_10208(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1161(void);
extern EIF_REFERENCE _A1161_183();
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1160, Current, 0, 1, 16768);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1160, Current, 16768);
	{
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1160, Current, 0, 1, 16769);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1160, Current, 16769);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,263,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1161_183, (EIF_POINTER)(0),7783, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1161_10208 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1160, Current, 0, 1, 16770);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1160, Current, 16770);
	RTIV(Current, RTAL);
