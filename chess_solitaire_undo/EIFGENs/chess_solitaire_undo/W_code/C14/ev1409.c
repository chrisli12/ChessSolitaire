...
extern EIF_TYPED_VALUE F1409_13304(EIF_REFERENCE);
static EIF_TYPED_VALUE F1409_13305_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1409_13305(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1409_13304 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1409_13305_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19773);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1409_13305 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9348, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1409_13305_body (Current)).it_r;
