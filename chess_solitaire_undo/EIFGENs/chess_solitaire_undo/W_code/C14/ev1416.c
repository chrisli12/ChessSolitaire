...
extern void F1416_13353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1416_13354(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1416_13358_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1416_13358(EIF_REFERENCE);
extern void EIF_Minit1416(void);
extern EIF_REFERENCE _A1219_335();
extern EIF_REFERENCE _A1219_334();
...
void F1416_13353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1415, Current, 0, 1, 19805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19805);
	RTCC(arg1, 1415, l_feature_name, 1, RTWCT(9348, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1416_13354 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1415, Current, 3, 0, 19806);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19806);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1219_334, (EIF_POINTER)(0),8206, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1219_335, (EIF_POINTER)(0),8207, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9869, dtype))(Current, up1x, ur1x, ur2x, ur3x);
	...
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10173, dtype))(Current, ur1x);
	RTHOOK(12);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9361, dtype))(Current, ub1x);
	if (RTAL & CK_ENSURE) {
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1415, Current, 2, 0, 19807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19807);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1415, Current, 1, 1, 19809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19809);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10187, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10187, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = *(EIF_REFERENCE *)(Current + RTWA(10187, dtype));
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
static EIF_TYPED_VALUE F1416_13358_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1415, Current, 0, 0, 19810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19810);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1416_13358 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9348, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1416_13358_body (Current)).it_r;
