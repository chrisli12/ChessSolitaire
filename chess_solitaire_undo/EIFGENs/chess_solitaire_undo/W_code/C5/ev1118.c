...
extern EIF_TYPED_VALUE F1118_9820(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1118_9820 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1117, Current, 0, 0, 16069);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1117, Current, 16069);
	RTIV(Current, RTAL);
