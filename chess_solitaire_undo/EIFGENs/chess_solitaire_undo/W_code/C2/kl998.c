...
extern EIF_TYPED_VALUE F998_8608(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_8609(EIF_REFERENCE);
...
RTOID (F998_8608)
EIF_TYPED_VALUE F998_8608 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14949);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F998_8609)
EIF_TYPED_VALUE F998_8609 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14950);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(7819, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
{
	GTCX
	RTOTS (8608,F998_8608)
	RTOTS (8609,F998_8609)
}
