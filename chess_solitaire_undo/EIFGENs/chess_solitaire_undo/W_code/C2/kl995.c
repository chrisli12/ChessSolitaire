...
extern EIF_TYPED_VALUE F995_8587(EIF_REFERENCE);
extern EIF_TYPED_VALUE F995_8588(EIF_REFERENCE);
...
RTOID (F995_8587)
EIF_TYPED_VALUE F995_8587 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14928);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F995_8588)
EIF_TYPED_VALUE F995_8588 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14929);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8587,F995_8587)
	RTOTS (8588,F995_8588)
}
