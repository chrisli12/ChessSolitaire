...
extern EIF_TYPED_VALUE F1198_10465(EIF_REFERENCE);
...
RTOID (F1198_10465)
EIF_TYPED_VALUE F1198_10465 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1197, Current, 0, 0, 17087);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1197, Current, 17087);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
