...
extern void F1436_13673(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1436_13674(EIF_REFERENCE);
static EIF_TYPED_VALUE F1436_13675_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_13675(EIF_REFERENCE);
...
void F1436_13673 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1435, Current, 0, 1, 20067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20067);
	RTCC(arg1, 1435, l_feature_name, 1, RTWCT(9348, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1436_13674 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 20068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20068);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9343, 1433))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1436_13675_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 20069);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20069);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1436_13675 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9348, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1436_13675_body (Current)).it_r;
