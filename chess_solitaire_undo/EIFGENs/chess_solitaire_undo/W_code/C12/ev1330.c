...
extern EIF_TYPED_VALUE F1330_12061(EIF_REFERENCE);
extern void F1330_12062(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1330_12061 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1330_12062 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1329, Current, 0, 0, 18756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1329, Current, 18756);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8419, 0xF80005DB, 0); /* implementation */
