...
extern EIF_TYPED_VALUE F1324_12032(EIF_REFERENCE);
extern void F1324_12033(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1324_12032 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1324_12033 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1323, Current, 0, 0, 18727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1323, Current, 18727);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8419, 0xF80005D1, 0); /* implementation */
