...
extern void F1327_12047(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1327_12048(EIF_REFERENCE);
extern void F1327_12049(EIF_REFERENCE);
extern void F1327_12050(EIF_REFERENCE);
extern void F1327_12051(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1327_12052(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1327_12053(EIF_REFERENCE);
extern void F1327_12054(EIF_REFERENCE);
...
void F1327_12047 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1326, Current, 0, 2, 18741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18741);
	RTCC(arg1, 1326, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1326, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1326, Current, 1, 0, 18742);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18742);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8721, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
void F1327_12049 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18743);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1327_12050 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18744);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1327_12051 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18745);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1327_12052 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18746);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = '\0';
	tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8424, 1319))(Current)).it_b);
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8424, 1276))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8424, 1284))(Current)).it_b);
		tb1 = tb2;
	}
...
void F1327_12054 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18748);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8419, 0xF80005D8, 0); /* implementation */
