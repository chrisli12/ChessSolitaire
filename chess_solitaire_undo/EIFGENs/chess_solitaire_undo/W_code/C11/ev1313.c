...
extern EIF_TYPED_VALUE F1313_11908(EIF_REFERENCE);
extern void F1313_11909(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1313_11908 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1313_11909 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1312, Current, 0, 0, 18603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1312, Current, 18603);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8419, 0xF80005B3, 0); /* implementation */
