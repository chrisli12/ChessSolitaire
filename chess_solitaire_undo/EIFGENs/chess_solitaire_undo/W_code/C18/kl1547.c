...
extern EIF_TYPED_VALUE F1547_15631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1547_15632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1547_15633(EIF_REFERENCE);
extern void F1547_15634(EIF_REFERENCE);
extern void F1547_15635(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1547_15631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1547_15632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1547_15633 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1547_15633,21703,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1547_15634 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1546, Current, 5, 0, 21703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1546, Current, 21703);
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(8);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11438, dtype));
		if (tb1) {
			RTHOOK(9);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11438, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1547_15635 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1546, Current, 0, 0, 21704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1546, Current, 21704);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
void F1547_15636 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1546, Current, 0, 0, 21705);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1546, Current, 21705);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
