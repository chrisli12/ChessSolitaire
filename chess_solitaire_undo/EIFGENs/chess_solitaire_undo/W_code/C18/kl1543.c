...
extern void F1543_15605(EIF_REFERENCE);
extern void F1543_15606(EIF_REFERENCE);
...
void F1543_15605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1542, Current, 0, 0, 21680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1542, Current, 21680);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1543_15606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1542, Current, 0, 0, 21681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1542, Current, 21681);
	RTIV(Current, RTAL);
