...
extern void F1477_14331(EIF_REFERENCE);
static EIF_TYPED_VALUE F1477_14332_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1477_14332(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1476, Current, 0, 1, 20549);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1476, Current, 20549);
	RTCC(arg1, 1476, l_feature_name, 1, RTWCT(9348, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1477_14331 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1476, Current, 1, 0, 20550);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9343, 1475))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1477_14332_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1477_14332 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9348, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1477_14332_body (Current)).it_r;
