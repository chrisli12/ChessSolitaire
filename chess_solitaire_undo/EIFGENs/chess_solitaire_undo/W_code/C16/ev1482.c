...
extern void F1482_14416(EIF_REFERENCE);
extern void F1482_14418(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1482_14419(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1482_14421(EIF_REFERENCE);
static EIF_TYPED_VALUE F1482_14422_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1482_14422(EIF_REFERENCE);
...
void F1482_14416 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1481, Current, 0, 0, 20633);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1481, Current, 20633);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1482_14418 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1481, Current, 0, 1, 20634);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1481, Current, 20634);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1482_14419 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1481, Current, 0, 0, 20635);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14418,1);
	RTDBGEAA(1481, Current, 20635);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	RTCOMS(tr2,14418,0,"W",1,87);
	ur1 = tr2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8564, "string_width", tr1))(tr1, ur1x)).it_i4);
...
EIF_TYPED_VALUE F1482_14421 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1481, Current, 0, 0, 20636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1481, Current, 20636);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1482_14422_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1481, Current, 0, 0, 20637);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1481, Current, 20637);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1482_14422 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9348, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1482_14422_body (Current)).it_r;
