...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 3, 0, 16249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16249);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
				tb5 = '\01';
				ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7647, "pos_y", Current));
				if (!(EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 2L)))) {
					ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7647, "pos_y", Current));
					tb5 = (EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 2L)));
				}
				tb4 = tb5;
			}
			if (!(tb4)) {
			...
			if (!tb3) {
				...
				if ((EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
					tb4 = '\01';
					ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
					if (!(EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 2L)))) {
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
						tb4 = (EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 2L)));
					}
					tb3 = tb4;
				}
				tb2 = tb3;
			...
			if (!tb2) {
				...
				if ((EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
					...
					if (!(EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 2L)))) {
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
						tb3 = (EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 2L)));
					}
					tb2 = tb3;
				}
				tb1 = tb2;
