...
extern EIF_TYPED_VALUE F1141_10098(EIF_REFERENCE);
extern void F1141_10099(EIF_REFERENCE);
extern void F1141_16465(EIF_REFERENCE, int);
...
/* {ROOT}.switch */
EIF_TYPED_VALUE F1141_10098 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1140, Current, 0, 0, 16331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1140, Current, 16331);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7717, dtype))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1141_10099 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1140, Current, 0, 0, 16332);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1140, Current, 16332);
	RTIV(Current, RTAL);
...
/* {ROOT}._invariant */
void F1141_16465 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1140, Current, 0, 16464);
	RTSA(dtype);
	RTME(dtype, 0);
