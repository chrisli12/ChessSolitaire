...
extern EIF_TYPED_VALUE F1134_10006(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1134_10006 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1133, Current, 3, 0, 16252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1133, Current, 16252);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		for (;;) {
			...
			if (tb1) {
				RTHOOK(8);
				ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
				ti4_2 = eif_abs_int32 ((EIF_INTEGER_32) (loc3 - ti4_1));
				ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7647, "pos_y", Current));
				ti4_3 = eif_abs_int32 ((EIF_INTEGER_32) (loc2 - ti4_1));
