...
extern EIF_TYPED_VALUE F1137_10019(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1137_10019 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 0, 1, 16261);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16261);
	RTCC(arg1, 1136, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
