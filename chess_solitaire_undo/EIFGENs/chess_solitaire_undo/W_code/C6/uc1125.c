...
extern EIF_TYPED_VALUE F1125_9952(EIF_REFERENCE);
...
RTOID (F1125_9952)
EIF_TYPED_VALUE F1125_9952 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1124, Current, 0, 0, 16198);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1124, Current, 16198);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
