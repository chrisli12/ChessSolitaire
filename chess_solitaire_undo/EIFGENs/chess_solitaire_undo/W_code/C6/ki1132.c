...
extern EIF_TYPED_VALUE F1132_10004(EIF_REFERENCE);
...
/* {KING}.possible_moves */
EIF_TYPED_VALUE F1132_10004 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1131, Current, 3, 0, 16250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1131, Current, 16250);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		for (;;) {
			...
			if (!(EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
				ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7647, "pos_y", Current));
				tb4 = (EIF_BOOLEAN)(loc3 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)));
			}
			if (tb4) {
				tb4 = '\01';
				...
				if (!(EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
					ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
					tb4 = (EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)));
				}
				tb3 = tb4;
			}
			if (!(tb3)) {
			...
			if (!tb2) {
				...
				if (!(EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
					ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7646, "pos_x", Current));
					tb3 = (EIF_BOOLEAN)(loc2 == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)));
				}
				if (tb3) {
					ti4_1 = *(EIF_INTEGER_32 *)(Current + RTVA(7647, "pos_y", Current));
